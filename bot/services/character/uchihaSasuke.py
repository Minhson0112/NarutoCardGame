...
class UchihaSasuke(Card):
    def special_skills(self):
        ...
        for target in targets:
            ...
            logs.append(
                f"🔥 {target.name} bị thiêu đốt bởi Amaterasu và giảm hồi máu trong 4 lượt, chịu {burn_damage} sát thương mỗi lượt!"
            )
            ...
            antiHeal = AntihealEffect(
                duration=4,
                value=0.5,
                description=f"giảm hồi máu của amaterasu từ {self.name}"
            )
